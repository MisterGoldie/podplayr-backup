...
export const PODPLAYR_OFFICIAL_DISPLAY_NAME = 'PODPLAYR';
...
export function officialAccountDisplayName(fid: number, displayName?: string | null) {
  if (fid === PODPLAYR_OFFICIAL_FID) return PODPLAYR_OFFICIAL_DISPLAY_NAME;
  return displayName || '';
}
