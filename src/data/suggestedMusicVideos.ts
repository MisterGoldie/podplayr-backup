...
export const SUGGESTED_MUSIC_VIDEOS: NFT[] = [
  ...
  {
    name: 'Calling',
    image: 'https://i2c.seadn.io/base/b565b94b51a6450d9053073e0b39c57c/6270897a43be0a58adeccc65d9eb55/b06270897a43be0a58adeccc65d9eb55.png',
    contract: '0x3709586a4f72fc60fbc847b5b6bbd86d06672c52',
    tokenId: '1',
    network: 'base',
    audio: 'https://gateway.pinata.cloud/ipfs/bafybeifgapj7vufewz6cynxjcjof36zqrf34274afyp2uwxbac34igcrny',
    isVideo: true,
    playbackMode: 'video-with-audio',
    collection: { name: 'XTincT' },
    metadata: {
      animation_url: 'https://gateway.pinata.cloud/ipfs/bafybeifgapj7vufewz6cynxjcjof36zqrf34274afyp2uwxbac34igcrny',
      mimeType: 'video/mp4',
      description: 'CALLING - ai music video',
    },
  },
  {
    name: 'Energy',
